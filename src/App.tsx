...
const I18N: Record<string, Record<string, string>> = {
  ...
  zh: { secP:'项目', pCnt:'3个项目', p1d:'负责任投资课程的投资组合跟踪系统。', pf:'投资组合', ch:'变化', gd:'黄金', lv:'实时', tF:'金融', tA:'实时API', p2t:'F1比赛预测', p2d:'使用FastF1和机器学习预测F1比赛结果。', drivers:'车手', cs:'即将推出', csd:'新项目开发中。', tba:'待公布', navP:'项目', navC:'联系' },
}
