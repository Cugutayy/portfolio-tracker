...
const s = StyleSheet.create({
  ...
  eventTitle: { fontSize: 16, fontWeight: "800", color: brand.text, marginBottom: 4 },
  eventMeta: { flexDirection: "row", alignItems: "center", gap: 4, marginBottom: 6 },
  eventMetaText: { fontSize: 11, color: brand.textDim, maxWidth: 140 },
  eventBottom: { flexDirection: "row", alignItems: "center", gap: 8 },
  eventAttendees: { fontSize: 11, color: brand.textMuted },
  joinBtn: {
    paddingHorizontal: 16, paddingVertical: 10,
    borderRadius: 12, borderWidth: 1.5, borderColor: brand.accent,
  },
  joinBtnActive: { backgroundColor: brand.accent, borderColor: brand.accent },
  joinText: { fontSize: 11, fontWeight: "800", color: brand.accent, letterSpacing: 1 },
