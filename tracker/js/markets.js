...
const SEARCH_SUGGESTIONS=[
  ...
  {sym:'PETKM.IS',name:'Petkim',cat:'BIST'},{sym:'KOZAL.IS',name:'Koza Altin',cat:'BIST'},
  {sym:'KOZAA.IS',name:'Koza Anadolu Metal',cat:'BIST'},{sym:'TTKOM.IS',name:'Turk Telekom',cat:'BIST'},
