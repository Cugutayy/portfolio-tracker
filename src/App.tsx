  ...
  return (
    <div className="font-ui" style={{
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
        <a href="mailto:s.cagatay.sonmez@gmail.com?subject=Erişim%20talebi%20%E2%80%94%20snmez.xyz" className="mono" style={{
          fontSize: '.62rem', letterSpacing: '.14em', textTransform: 'uppercase',
          border: '1px solid var(--ink)', padding: '10px 18px', borderRadius: 999, color: 'var(--bg)', background: 'var(--ink)', textDecoration: 'none',
        }}>{t('lockReq')} →</a>
