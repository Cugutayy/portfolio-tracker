...
const s = StyleSheet.create({
  ...
  memberAvatar: { width: 42, height: 42, borderRadius: 21, backgroundColor: brand.surface, borderWidth: 1, borderColor: brand.border, justifyContent: "center", alignItems: "center" },
  memberAvatarImage: { width: 40, height: 40, borderRadius: 20 },
  memberAvatarText: { fontSize: 14, fontWeight: "bold", color: brand.accent },
  memberName: { fontSize: 15, fontWeight: "700", color: brand.text },
  ...
  title: { fontSize: 24, fontWeight: "800", color: brand.text, letterSpacing: 0.5, marginBottom: 4, paddingHorizontal: 20, paddingTop: 16 },
  ...
  statBox: { backgroundColor: brand.surface, borderWidth: 1, borderColor: brand.border, borderRadius: 12, padding: 18, minWidth: "30%", flex: 1, alignItems: "center" },
  statValue: { fontSize: 20, fontWeight: "800", color: brand.text },
  ...
  splitsSection: { backgroundColor: brand.surface, borderWidth: 1, borderColor: brand.border, borderRadius: 12, padding: 16, marginHorizontal: 20, marginBottom: 16 },
  ...
  // Kudos
  kudosSection: { marginHorizontal: 20, marginBottom: 16, backgroundColor: brand.surface, borderWidth: 1, borderColor: brand.border, borderRadius: 12, padding: 16 },
  ...
  // Comments
  commentsSection: { marginHorizontal: 20, marginBottom: 16, backgroundColor: brand.surface, borderWidth: 1, borderColor: brand.border, borderRadius: 12, padding: 16 },
